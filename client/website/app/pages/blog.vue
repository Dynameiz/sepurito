...
<template>
    <div class="w-full min-h-screen max-w-3xl mx-auto flex flex-col justify-start">

        <span id="the-beginning" class="flex flex-row gap-2 text-4xl font-bold mt-32 mb-8 text-left">
            <h1>How It All</h1>
            <h1 class="text-[#05df72]">Began</h1>
        </span>

        <p class="text-lg text-justify indent-8">
        ...
        <blockquote class="border-l-4 border-[#05df72] pl-4 italic my-8 bg-black/20 p-4 text-lg backdrop-blur-md">
        ...
        <span id="understanding-problem" class="flex flex-row gap-2 text-4xl font-bold mb-8 text-left">
            <h1 class="text-[#05df72]">Step 1</h1>
            <h1 class="text-white/70">-</h1>
            <h1>Understanding the Real Problem</h1>
        </span>
        ...
        <ul class="list-disc pl-6 text-lg leading-relaxed mt-4">
        ...
        <span id="first-attempt" class="flex flex-row gap-2 text-4xl font-bold mb-8 text-left">
        ...
        <p class="text-lg text-justify indent-8 mt-4">
        ...
        <p class="text-lg text-justify mt-8 text-white/60">
        ...
        <span id="swtiching-things-up" class="flex flex-row gap-2 text-4xl font-bold mb-8 text-left">
        ...
        <div id="to-be-continued" class="flex flex-col gap-2 my-16 text-center">
            <h1 class="text-white/75 text-4xl font-bold">To Be Continued...</h1>
            <p class="text-white/50 text-lg">Next up: The Design and Implementation of the User Interface</p>
        </div>
